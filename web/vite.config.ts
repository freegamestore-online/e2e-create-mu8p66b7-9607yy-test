...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: "Create Canary e2e-create-mu8p66b7-9607yy-test",
        short_name: "Create Canary e2e-create-mu8p66b7-9607yy-test",
        description: "Create Canary e2e-create-mu8p66b7-9607yy-test — free forever",
        start_url: "/",
        display: "standalone",
